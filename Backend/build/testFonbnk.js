...
function testFonbnkIntegration() {
    return __awaiter(this, void 0, void 0, function* () {
        console.log("🧪 Testing Fonbnk Integration...\n");
        const fonbnkService = new FonbnkService_1.FonbnkService(testConfig);
        try {
            ...
            const countries = yield fonbnkService.getSupportedCountries();
            console.log("✅ Supported countries:", countries);
            console.log("");
            // Test 3: Get supported currencies
            console.log("3. Testing supported currencies...");
            const currencies = yield fonbnkService.getSupportedCurrencies();
            ...
            const testSignature = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiJ0ZXN0X3VpZCJ9.test_signature";
            const webhookResult = fonbnkService.processWebhook(testWebhookPayload, testSignature);
            ...
            const orderStatus = yield fonbnkService.getOrderStatus("test_order_123");
...
//# sourceMappingURL=testFonbnk.js.map